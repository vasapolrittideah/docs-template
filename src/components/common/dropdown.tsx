...
import { PolymorphicComponentProps } from '@/lib/react';
...
>(({ className, sideOffset = 8, ...rest }, forwardedRef) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'bg-bg-white-0 shadow-regular-md ring-stroke-sub-300 z-50 w-75 overflow-hidden rounded-xl ring-1 ring-inset',
        'flex flex-col gap-1',
        // origin
...
>(({ className, ...rest }, forwardedRef) => (
  <DropdownMenuPrimitive.Group ref={forwardedRef} className={cn('flex flex-col gap-1', className)} {...rest} />
));
...
>(({ className, ...rest }, forwardedRef) => (
  <DropdownMenuPrimitive.Label
    ref={forwardedRef}
    className={cn('text-subheading-xs text-text-soft-400 px-2 py-1 uppercase', className)}
    {...rest}
  />
));
...
>(({ className, ...rest }, forwardedRef) => (
  <DropdownMenuPrimitive.SubContent
    ref={forwardedRef}
    className={cn(
      'bg-bg-white-0 shadow-regular-md ring-stroke-soft-200 z-50 w-max overflow-hidden rounded-xl p-2 ring-1 ring-inset',
      'flex flex-col gap-1',
      // animation
      'data-[state=open]:animate-in data-[state=open]:fade-in-0',
      'data-[state=closed]:animate-out data-[state=closed]:fade-out-0',
